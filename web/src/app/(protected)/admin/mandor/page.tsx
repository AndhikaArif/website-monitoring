                  ...
                  {loading ? (
                    ...
                    mandors.map((m) => (
                      ...
                      >
                        ...
                        <td
                          className="p-5 hidden lg:table-cell cursor-pointer"
                          onClick={() => handleRowClick(m)}
                        >
                        ...
                        <td
                          className="p-5 hidden md:table-cell text-gray-600 cursor-pointer"
                          onClick={() => handleRowClick(m)}
                        >
                        ...
                        {/* Area tombol Aksi (Dibiarkan terpisah agar klik Edit/Hapus tidak membuka Modal) */}
