...
import { updateMandorSchema } from "@/validation/mandor.validation";
import { getMandorById, updateMandor } from "@/services/mandor.service";
import { UpdateMandorPayload } from "@/types/mandor.type";
import PasswordField from "@/components/form/passwordField";

export default function EditMandorPage() {
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="bg-linear-to-r from-blue-600 to-blue-700 px-8 py-10 text-white">
            <h1 className="text-3xl font-bold">Edit Profil Mandor</h1>
            <p className="text-blue-100 mt-2 opacity-90">
              Perbarui informasi akun dan kredensial akses mandor.
            </p>
          </div>
          ...
          <div className="p-8">
            <Formik
              ...
              validationSchema={toFormikValidationSchema(updateMandorSchema)}
              onSubmit={async (values, { setSubmitting, setErrors }) => {
                try {
                  const payload: UpdateMandorPayload = {
                    name: values.name,
