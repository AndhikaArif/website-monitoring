...
import { createHeadWorkerSchema } from "@/validation/head-worker.validation";
import PasswordField from "@/components/form/passwordField";

export default function CreateHeadWorkerPage() {
          ...
          <div className="p-8">
            <Formik
              ...
              onSubmit={async (values, { setSubmitting, setErrors }) => {
                try {
                  await axios.post(
                    `${process.env.NEXT_PUBLIC_API_DOMAIN}/api/head-worker/`,
                    values,
