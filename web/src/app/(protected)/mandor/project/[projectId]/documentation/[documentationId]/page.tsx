  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-8 text-black">
      <div className="max-w-4xl mx-auto">
        ...
        {/* CONTAINER UTAMA (Vertical Stack) */}
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 border-t border-gray-100 pt-6">
              ...
              <div>
                <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-3 flex items-center gap-2">
                  <FiTarget className="text-purple-500" /> Target Pekerjaan
                </h3>
          ...
          {/* BAGIAN 3: LAMPIRAN FILE DI BAWAH (FULL WIDTH) */}
          <div className="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-gray-100">
            <h3 className="font-bold text-xl text-gray-800 mb-6 flex items-center gap-2">
              <FiImage className="text-purple-600" /> Bukti Dokumentasi Lapangan
            </h3>

            {/* Grid dinamis: 2 kolom di HP, 3 di Tablet, 4 di Desktop */}
