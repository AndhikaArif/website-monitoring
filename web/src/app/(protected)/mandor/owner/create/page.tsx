...
import { createOwnerSchema } from "@/validation/owner.validation";
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8 text-black">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
          {/* HEADER CARD - Tetap Purple karena diakses oleh Mandor */}
          <div className="bg-linear-to-r from-purple-600 to-purple-700 px-8 py-10 text-white">
            <h1 className="text-3xl font-bold flex items-center gap-3">
              <FiPlusCircle /> Tambah Klien Baru
            </h1>
            <p className="text-purple-100 mt-2 opacity-90">
              Daftarkan akun untuk klien / pemilik rumah agar mereka dapat
          ...
          <div className="p-8">
            <Formik
              ...
              validationSchema={toFormikValidationSchema(createOwnerSchema)}
                ...
                <Form className="space-y-6">
                  ...
                  <div className="bg-gray-50 p-5 rounded-2xl border border-gray-100">
                    <PasswordField
                      ...
                      label="Password Akun"
                      role="MANDOR"
                      placeholder="Buat password untuk klien"
                    ...
                    <p className="text-[11px] text-gray-500 mt-2 flex items-start leading-tight">
                      ...
                      ini kepada Klien terkait agar mereka bisa masuk ke sistem.
                    </p>
                  </div>
