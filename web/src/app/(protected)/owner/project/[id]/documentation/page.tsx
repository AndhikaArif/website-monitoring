    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8 text-black">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
          {/* HEADER BANNER - TEMA AMBER */}
          <div className="bg-amber-600 px-6 py-8 md:px-10 md:py-10 text-white relative overflow-hidden">
            <div className="relative z-10">
              <h1 className="text-3xl font-bold flex items-center gap-3">
                <FiFileText /> Riwayat Laporan Harian
              </h1>
              <p className="text-amber-100 mt-2 text-sm md:text-base max-w-xl">
                Pantau progres proyek rumah Anda secara transparan melalui
                laporan yang diunggah secara rutin oleh tim lapangan.
              </p>
            </div>
            {/* Dekorasi Background */}
            <div className="absolute -right-10 -top-10 w-40 h-40 bg-amber-500 rounded-full opacity-50 blur-3xl"></div>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-8">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-2 focus:ring-amber-500 transition-all text-sm"
                />
              </div>
              ...
              <div className="flex gap-2">
                <div className="relative flex-1 md:w-48">
                  ...
                  <select
                    ...
                    className="w-full pl-11 pr-8 py-3 bg-gray-50 border border-gray-100 rounded-2xl appearance-none focus:outline-none focus:ring-2 focus:ring-amber-500 transition-all text-sm font-medium text-gray-700 cursor-pointer"
                  >
                ...
                <button
                  onClick={toggleOrder}
                  className="p-3 bg-gray-50 border border-gray-100 rounded-2xl text-gray-600 hover:text-amber-600 hover:bg-amber-50 transition-all flex items-center justify-center cursor-pointer"
                >
                  {order === "asc" ? (
                    <FiArrowUp size={20} />
                  ) : (
            ...
            <div className="space-y-4">
              {loading && docs.length === 0 ? (
                <div className="flex justify-center py-12">
                  <FiLoader className="animate-spin text-amber-600 text-3xl" />
                </div>
              ) : docs.length > 0 ? (
                docs.map((doc) => (
                  <div
                    ...
                    className="border border-gray-100 rounded-2xl p-5 hover:border-amber-300 hover:shadow-md transition-all bg-white flex flex-col md:flex-row md:items-center justify-between gap-5 group cursor-pointer"
                  >
                    ...
                    <div className="flex items-center gap-3 bg-gray-50 border border-gray-100 px-4 py-3 rounded-xl shrink-0">
                      <div className="w-9 h-9 rounded-full bg-amber-200 flex items-center justify-center text-amber-700 font-bold text-sm shadow-inner">
                ...
                <div className="text-center py-20 border-2 border-dashed border-gray-200 rounded-3xl bg-gray-50/50">
                  ...
                  <p className="text-sm text-gray-400 mt-2">
                    {debouncedSearch
                      ...
                      : "Tim lapangan belum mengirimkan dokumentasi untuk proyek ini."}
                  </p>
                </div>
              )}
            </div>
            ...
            {!loading && totalPages > 1 && (
              <div className="flex flex-col sm:flex-row justify-between items-center mt-10 pt-6 border-t border-gray-100 gap-4">
                <p className="text-sm text-gray-500 font-medium">
                  Menampilkan Halaman{" "}
                  <span className="font-bold text-amber-600">{page}</span> dari{" "}
                  {totalPages}
                </p>
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-5 py-2.5 border border-gray-200 rounded-xl text-sm font-bold disabled:opacity-40 disabled:cursor-not-allowed hover:bg-gray-50 hover:text-amber-600 transition-all bg-white shadow-sm cursor-pointer"
                  >
                    Sebelumnya
                  </button>
                  <button
